...
class CrmGoogleContactSync < ActiveRecord::Base
  ...
  def CrmGoogleContactSync.sync_1
            ...
            if gcontact_group_member_ship_info and gcontact_group_member_ship_info == google_contact_sync.contact_group_id
              ...
              if contact == nil
                ...
                if contact.updated_status == true
                  ...
                  if   Address.find(:last , :conditions => ['addressable_id = ? And address_type ="Business"',contact.id ]) and entry.elements['gd:postalAddress'].text != Address.find(:last , :conditions => ['addressable_id = ? And address_type ="Business"',contact.id ]).full_address
            ...
            if gcontact_group_member_ship_info and gcontact_group_member_ship_info == google_contact_sync.lead_group_id
              ...
              if lead == nil
                ...
                if lead.updated_status == true
                  ...
                  if   Address.find(:last , :conditions => ['addressable_id = ? And address_type ="Business"',lead.id ]) and entry.elements['gd:postalAddress'].text != Address.find(:last , :conditions => ['addressable_id = ? And address_type ="Business"',lead.id ]).full_address
